...
## Для пользователей
* Пользователи создают собственную анкету, в которой рассказывают о своих достижениях, делятся ценной рекомендацией
* После им открывается доступ к оценке других участников по 5-бальной шкале. Они также выбирают категорию, по которой им будут показываться анкеты
